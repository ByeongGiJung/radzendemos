...
using Radzen.Blazor;
using RadzenDemos.Shared;

namespace RadzenDemos
{
...
";
        ...
        private async Task InitializeAsync()
        {
            ...
            {
                builder.SetRootNamespace("RadzenDemos");
        ...
        public async Task<Type> CompileAsync(string source)
        {
            ...
            var type = assembly.GetType("RadzenDemos.DynamicComponent");
